...
import { Typography, Paper, Snackbar, Alert, Tooltip, type AlertColor, Button, Box, FormControlLabel, Checkbox } from '@mui/material';
...
export default function ImportExport() {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        if (file.type.startsWith('image/')) {
          ...
          reader.onload = (e) => {
            ...
            if (loaded === files.length) {
              ...
              if (searchable) {
                ...
                showNotification('Images imported and added to the search database!');
          ...
          reader.onload = (e) => {
            ...
            showNotification('File imported! (See console for contents)', 'info');
  ...
  return (
    <Paper elevation={2} sx={{ p: 4 }}>
      ...
      <Tooltip title={dbImages.length === 0 ? "No images in database to export" : "Download the image database as JSON"}>
        <span>
          <Button
            variant="outlined"
            sx={{ mt: 4 }}
